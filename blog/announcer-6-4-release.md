...
Announcer v6.4 is now available. This is a maintenance release that includes a number of enhancements and bug fixes. It is now available for both free and PRO versions.
...
### ✨ Changelog
* __New__: New location rules to target WooCommerce pages.
* __Fix__: Misc Admin UI enhancements.
