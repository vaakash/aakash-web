...
Announcer v6.3 is now available. This is a maintenance release that includes a number of enhancements and bug fixes. It is now available for both free and PRO versions.
...
### ✨ Changelog
* __New__: Option to start the ticker scroll from the middle of the screen.
* __Fix__: Optimized ticker animation for better performance.
* __PRO__: Countdown date time picker not working in some cases.
