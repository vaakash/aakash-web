---
title: Shortcoder v6.5.3 Release
taxonomy:
    category: blog
    post_tag:
        - release
...
Shortcoder v6.5.3 is now available. This is a maintenance release that includes a number of enhancements and bug fixes. It is now available for both free and PRO versions.
...
Shortcoder PRO v6.5.3 now supports translation of shortcode content with WPML plugin.
...
* __Fix__: Support for WordPress 6.9
